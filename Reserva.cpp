        ...
        while(getline(readData,aux)){
            ...
            if(specie[0] == 'S'){
                if(specie == "SCoelho"){
                    ...
                    iss >> iAux;
                    // TODO: Apply default health value for Caranguejo
                    t << "iAux SCaranguejo: " << iAux << "\n";
                ...
                if(specie == "VCoelho"){
                    ...
                    iss >> iAux;
                    // TODO: Apply default life value for Caranguejo
                    t << "iAux VCaranguejo: " << iAux << "\n";
                ...
                if(specie == "FCoelho"){
                    ...
                    iss >> iAux;
                    // TODO: Apply default hunger value for Caranguejo
                    t << "iAux FCaranguejo: " << iAux << "\n";
                ...
                if(specie == "PCoelho"){
                    ...
                    iss >> iAux;
                    // TODO: Apply default weight value for Caranguejo
                    t << "fAux PCaranguejo: " << fAux << "\n";
